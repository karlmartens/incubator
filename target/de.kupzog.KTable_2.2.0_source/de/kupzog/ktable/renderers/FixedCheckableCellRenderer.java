 ...
 * <code>FixedCellRenderer</code>). Instead of painting text and images, 
...
public class FixedCheckableCellRenderer extends CheckableCellRenderer {
    ...
    /**
     * Check for sort indicator and delegate content drawing to drawCellContent()
     */
    private void drawCellContent(GC gc, Rectangle rect, int col, Object content, 
            KTableModel model, Color bgColor, Color fgColor, boolean clicked) {
