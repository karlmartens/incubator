...
/**
 * Default implementation that handles column widths and row height.<p>
 * Provides a wrapper framework that allows subclasses to transparently
 * change the location of cells in the displayed table, e.g. for sorting.
 * 
...
public abstract class KTableDefaultModel implements KTableModel {
     ...
     * @return Returns the initial row height that should
     * be used on normal cells. If resize is enabled, the value
     * returned by <code>getRowHeight(int)</code> might not 
     * always be this value!
     */
    public abstract int getInitialRowHeight(int row);
    
    /**
     * @return Returns the height of the first row. 
     * Adapts to the value returned by the method getInitialFirstRowHeight() as long as no value is set via setFirstRowHeight(int).
     ...
     * @param col The column index.
     * @param row The row index.
     * @return Returns the content of the cell thats string form
     *  is shown in the table cell.
     */
     ...
     * @param col The column index.
     * @param row The row index.
     * @return Returns the cell editor to use, or <code>null</code> 
     * if none.
     */
     ...
     * @param col the column index
     * @param row The row index
     * @return Returns a cellrenderer that renders the cell in the
     * KTable.
     */
     ...
     * @param col the column index
     * @param row the row index
     * @return returns true if the cell is fixed AND a header cell, false otherwise.
     */
    ...
    /**
     * @return Returns the total number of fixed rows in the table.
     * This is nothing else than the sum of header rows and selectable fixed rows.
    ...
    /**
     * @return Returns the total number of fixed columns in the table.
     * This is nothing else than the sum of header columns and selectable fixed columns.
	 ...
	 * Calls the client method that should be implemented instead of this method.
	 * @see #doGetRowCount()
	 */
