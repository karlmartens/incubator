 ...
 * 
 */
public final class CutTableViewerAction extends TableViewerEditAction {

  public CutTableViewerAction() {
    setText(Messages.CUT.string());
    setImageDescriptor(Images.CUT);
  }
