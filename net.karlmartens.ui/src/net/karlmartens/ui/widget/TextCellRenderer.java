...
class TextCellRenderer extends de.kupzog.ktable.renderers.TextCellRenderer {
   ...
   *          - INDICATION_FOCUS makes the cell that has the focus have a
   *          different background color and a selection border.<br>
   *          - INDICATION_FOCUS_ROW makes the cell show a selection indicator
   *          as it is often seen in row selection mode. A deep blue background
   *          and white content.<br>
   *          - INDICATION_COMMENT lets the renderer paint a small triangle to
   *          the right top corner of the cell.<br>
  ...
  public void drawCell(GC gc, Rectangle rect, int col, int row, Object content,
     ...
     * rect = drawSolidCellLines(gc, rect, vBorderColor, hBorderColor, topWidth,
