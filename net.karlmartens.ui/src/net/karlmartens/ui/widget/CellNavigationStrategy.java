...
public final class CellNavigationStrategy {
	...
	private Point doPageUp(TimeSeriesTable table, 
			Point currentSelectedCell, Event event) {
		return null;
	}

	private Point doPageDown(TimeSeriesTable table, 
			Point currentSelectedCell, Event event) {
		return null;
	}

	private Point doHome(TimeSeriesTable table, 
			Point currentSelectedCell, Event event) {
	...
	private Point doEnd(TimeSeriesTable table, 
			Point currentSelectedCell, Event event) {
		final TimeSeriesTableItem item = table.getItem(currentSelectedCell.y);		
		final int columnCount = table.getColumnCount();
